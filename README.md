...
- Original atlas is provided in 0.5mm iso MNI space. Other atlases shared here have been resampled using ants registration and a partial volume >0.2 to avoid dilution of the small ROI. Weighted averaging or nearest neighbor statistics based on the high-resolution atlas are recommended for analysis.
